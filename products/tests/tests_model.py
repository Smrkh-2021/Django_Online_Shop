...
class DiscountTest(TestCase):
    def setUp(self) -> None:
        ...
        self.discount4 = Discount.objects.create(value=20, type='percent', max_price='30000', expire_time=datetime.strptime('2022-02-17', "%Y-%m-%d").date())
        self.discount5 = Discount.objects.create(value=10000, type='price', max_price='5000', expire_time=datetime.strptime('2022-02-18', "%Y-%m-%d").date())
    ...
    def test1_profit_price10000(self):
        ...
        self.assertEqual(self.discount4.profit_value(10000), 2000)
        self.assertEqual(self.discount5.profit_value(10000), 10000)
